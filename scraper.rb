...
def textBlock(monster, titleXPath, descriptionXPath)
    ...
    return titles.zip(descriptions).reduce(:+)
end
...
def monsterPage(url)
    ...
    puts size, type, alignment, ac, speed
    ...
    puts proficiency, saving_throws, skills, senses, languages
...
# CR is getting messed up b/c some monsters dont have saving throws
    ...
    puts legendaryActionsText, legendaryActions
